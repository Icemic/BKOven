...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../ScenarioImportWizard/release/ -lScenarioImportWizard
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../ScenarioImportWizard/debug/ -lScenarioImportWizard
else:unix: LIBS += -L$$OUT_PWD/../ScenarioImportWizard/ -lScenarioImportWizard

INCLUDEPATH += $$PWD/../ScenarioImportWizard
DEPENDPATH += $$PWD/../ScenarioImportWizard

win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../ScenarioImportWizard/release/libScenarioImportWizard.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../ScenarioImportWizard/debug/libScenarioImportWizard.a
