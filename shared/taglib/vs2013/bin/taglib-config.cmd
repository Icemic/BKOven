...
:doit
if /i "%1#" == "--libs#"    echo -LD:/workspace/Git/taglib-1.9.1/dist/lib -llibtag
if /i "%1#" == "--cflags#"  echo -ID:/workspace/Git/taglib-1.9.1/dist/include/taglib
if /i "%1#" == "--version#" echo 1.9.1
if /i "%1#" == "--prefix#"  echo D:/workspace/Git/taglib-1.9.1/dist
